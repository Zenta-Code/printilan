...
exports.StoreSeeder = void 0;
var store_1 = require("../model/store");
var user_1 = require("../model/user");
var StoreSeeder = function () { return __awaiter(void 0, void 0, void 0, function () {
    var user, store;
            ...
            case 1:
                ...
                return [4 /*yield*/, store_1.Store.findOneAndUpdate({ name: "Matt's Store" }, {
                        $set: {
                            ...
                            phone: "1234567890",
                            ownerId: user === null || user === void 0 ? void 0 : user._id
                        }
...
exports.StoreSeeder = StoreSeeder;
