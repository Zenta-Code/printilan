...
mixin _$OrderState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<OrderEntityResponse> data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<OrderEntityResponse> data)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<OrderEntityResponse> data});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<OrderEntityResponse> data) : _data = data;

  final List<OrderEntityResponse> _data;
  @override
  List<OrderEntityResponse> get data {
...
abstract class _Success implements OrderState {
  const factory _Success(final List<OrderEntityResponse> data) = _$SuccessImpl;
