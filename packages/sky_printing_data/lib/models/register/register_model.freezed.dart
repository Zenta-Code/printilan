...
class _$RegisterModelImpl extends _RegisterModel {
  const _$RegisterModelImpl({this.id, this.token, this.error}) : super._();
  ...
  @override
  String toString() {
    return 'RegisterModel(id: $id, token: $token, error: $error)';
  }
...
abstract class _RegisterModel extends RegisterModel {
  const factory _RegisterModel(
      {final int? id,
      final String? token,
      final String? error}) = _$RegisterModelImpl;
