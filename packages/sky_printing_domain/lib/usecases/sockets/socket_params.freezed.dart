...
class _$SocketParamsImpl implements _SocketParams {
  ...
  @override
  String toString() {
    return 'SocketParams(roomId: $roomId, storeId: $storeId, userId: $userId, sender: $sender, receiver: $receiver, content: $content)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, roomId, storeId, userId, sender,
      receiver, const DeepCollectionEquality().hash(_content));
