...
/// @nodoc
@JsonSerializable()
class _$LocationParamsImpl implements _LocationParams {
  const _$LocationParamsImpl(
      {this.latitude = 0,
      this.longitude = 0,
      this.accuracy = 0,
      ...
      this.elapsedRealtimeUncertaintyNanos = 0,
...
abstract class _LocationParams implements LocationParams {
  const factory _LocationParams(
      {final double latitude,
      final double longitude,
      final double accuracy,
      final double verticalAccuracy,
      ...
      final double elapsedRealtimeUncertaintyNanos,
      final int satelliteNumber,
      final String provider}) = _$LocationParamsImpl;
